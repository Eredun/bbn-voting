...
btn.addEventListener('click', e => {
  if (votesCounter.textContent <= 0) {
    ...
    newContestants.map((contestants, index, newContestants) => {
        leaderboardNames.forEach((username, elIndex) => {
          if(index === elIndex) {
            console.log(contestants.name);
            console.log(username);
            username.textContent = contestants.name;
          } 
          // else {
          //   ''
          // }
