...
const totalMarks = document.querySelector('.total-marks').textContent;

console.log(totalMarks);
document.querySelector('.total-marks').addEventListener('change', e => {
  if (parseInt(document.querySelector('total-marks')) === 0 ) {
    console.log(housemates);
  }
})
